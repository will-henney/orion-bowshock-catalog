...
#+BEGIN_SRC python :return figlist :results list
  import numpy as np
  import matplotlib.pyplot as plt
  from  astropy.table import Table

  def label_sources(labels, x, y, extramask=None):
      """Add labels at points (x, y) for selected sources"""
      mask = always_annotate
  ...
  always_annotate = np.array(['LL' in source for source in tab['Object']])
  famous = ['177-341', '167-317', '168-326', '161-324']
  always_annotate = always_annotate | np.array([source in famous for source in tab['Object']])
  figlist = []
  ...
  label_sources(tab['Object'], A, H, (A > 5.0) | (A < 1.0) | (H <= 0.2) | (H >= 0.6))
  cb = plt.colorbar()
  cb.set_label('Projected distance from Trapezium, D / arcmin')
  ...
  label_sources(tab['Object'], D60, q)
  cb = plt.colorbar()
...
|------------+--------------+----------+--------------+--------------+--------------+-------------+-----------------------+-----|
| LL2        |              | IX Ori   |   5:34:40.86 |   -5:22:42.2 | BR01         |          18 |                       | x   |
| LL3        |              |          |  5:34:40.807 |   -5:26:38.6 | BR01         |          17 |                       | x   |
| LL4        |  LL 4427-838 |          |  5:34:42.724 |  -5:28:37.38 | BR01         |          24 |                       | x   |
|            | LLP 4468-605 |          |  5:34:46.765 |  -5:26:04.74 | BLSW06       |          17 | proplyd - axial jet   | x   |
|            |  LL 4578-251 |          |   5:34:57.79 |   -5:22:51.1 | WJH          |          09 |                       | x   |
|            | LLP 4582-635 |          |   5:34:58.17 |   -5:26:35.1 | WJH          |          16 | proplyd - very faint  | x   |
|            |     w000-400 |          |   5:34:59.57 |   -5:24:00.4 | BOM00        |          09 | proplyd? 4596-400     | x   |
|            |     w005-514 |          |  5:35:00.463 |  -5:25:14.22 | BOM00        |      01, 16 | proplyd               | xx  |
|            |     w012-407 |          |  5:35:01.175 |  -5:24:06.68 | BOM00        |          01 |                       | x   |
|            |     w014-414 |          |  5:35:01.373 |  -5:24:13.42 | BOM00        |          01 |                       | x   |
|            |   LL 022-635 |          |   5:35:02.20 |   -5:26:35.3 | WJH          |          16 |                       | x   |
|            |     w030-524 |          |  5:35:03.001 |  -5:25:24.35 | BOM00        |          01 |                       | x   |
|            |   LL 041-637 |          |   5:35:04.05 |   -5:26:37.3 | WJH          |          16 |                       | x?  |
|            |  LLP 042-628 |          |   5:35:04.19 |   -5:26:27.7 | WJH          |          16 | proplyd 038-627       | x   |
|            |     w044-527 |          |  5:35:04.422 |  -5:25:27.39 | BOM00        |          01 |                       | x   |
|            |  LLP 049-143 |          |   5:35:04.95 |   -5:21:42.9 | WJH          |          09 | proplyd               | x   |
|            |  LLP 051-024 |          |   5:35:05.13 |   -5:20:24.3 | WJH          |          09 | proplyd               | x   |
| LL1        |     w056-519 | LL Ori   |   5:35:05.64 |   -5:25:19.4 | BR01, BOM00  |          01 |                       | x   |
|            |      065-502 |          |  5:35:06.534 |  -5:25:01.53 | WJH          |          01 | proplyd?              | x   |
|            |     066-3251 |          |   5:35:06.57 |  -5:32:51.49 | WJH (R08)    |          14 | proplyd?, globule?    | x   |
|            |     w069-601 |          |   5:35:06.91 |   -5:26:00.6 | BOM00        |          01 |                       | x   |
|            |  LLP 072-134 |          |   5:35:07.20 |   -5:21:34.3 | WJH          |          09 | proplyd - thin shell  | x   |
|            |     w073-227 |          |   5:35:07.27 |   -5:22:26.6 | BOM00        |          01 | proplyd               | x   |
|            |      074-229 |          |  5:35:07.381 |  -5:22:28.92 | WJH          |          01 | very faint            |     |
