...
**** TODO Better estimate of shell thickness
+ We are currently using R_{out} - R_{in} but that won't do since in general the tow circles are not concentric
...
#+BEGIN_SRC sh :results verbatim replace
  cd j8oc${field}010_wcs
  python ../programas/plot-image.py --image Bally_${field} --vmin ${vmin} --vmax ${vmax} ${source}  
#+END_SRC
...
+ [X] LL2 - should not use lower shell - jet
  #+BEGIN_SRC sh
  xpaset -p ds9 fits j8oc18010_wcs/LL2-Bally_18-extract.fits
  xpaset -p ds9 regions delete all
  xpaset -p ds9 align wcs
  xpaset -p ds9 zoom to fit
  xpaset -p ds9 scale limits 1.0 2.5
  xpaset -p ds9 cmap invert
  #+END_SRC

#+BEGIN_SRC sh 
  xpaset -p ds9 regions load j8oc18010_wcs/LL2-forma.reg
#+END_SRC
...
WARNING: AstropyBackwardsIncompatibleChangeWarning: Using the `ICRSCoordinates` name for this class is deprecated in v0.3, and will be removed in the next version. Use `ICRS` instead. [astropy.coordinates.old_builtin_systems_names]
[[Variables]]
     xc:    -11.766191 +/- 1.178571 (10.02%) initial = -2.073590
     yc:     0.379769 +/- 0.131958 (34.75%) initial = -0.016659
[[Correlations]] (unreported correlations are <  0.100)
    C(xc, yc)                    =  0.439 
[[Variables]]
     xc:    -24.090728 +/- 3.921345 (16.28%) initial = -3.999462
     yc:     1.757962 +/- 0.462180 (26.29%) initial =  0.533528
[[Correlations]] (unreported correlations are <  0.100)
    C(xc, yc)                    =  0.552 
WARNING: FITSFixedWarning: The WCS transformation has more axes (2) than the image it is associated with (0) [astropy.wcs.wcs]
WARNING: AstropyBackwardsIncompatibleChangeWarning: Using the `ICRSCoordinates` name for this class is deprecated in v0.3, and will be removed in the next version. Use `ICRS` instead. [astropy.coordinates.old_builtin_systems_names]
RA range: 5:34:39.8688 5:34:41.7995
Dec range: -5:22:57.53 -5:22:05.55
Extracted image window: [1387:2525, 3605:4754]
WARNING: Overwriting existing file 'LL2-Bally_18-extract.fits'. [astropy.io.fits.file]
#+end_example

#+BEGIN_SRC sh :dir j8oc18010_wcs :results verbatim replace
  source activate py27
  python ../programas/arc_brightness.py LL2
#+END_SRC

#+BEGIN_SRC sh :dir j8oc18010_wcs :results verbatim replace
  python ../programas/plot-image.py --image Bally_18 --vmin 1.0 --vmax 2.5 LL2 
#+END_SRC


#+RESULTS:
: 83.67025000000001 -5.378388888888889
: 0.007758443642322924
: INFO: Deleting work directory /var/folders/rm/hnrktx9s22g8sbms445k0z000000gn/T/tmp652c5y [montage_wrapper.wrappers]
: INFO: Deleting work directory /var/folders/rm/hnrktx9s22g8sbms445k0z000000gn/T/tmpds157h [montage_wrapper.wrappers]
: No mask regions found

#+BEGIN_SRC sh :dir j8oc18010_wcs
  open LL2-Bally_18-images.pdf
#+END_SRC

+ [X] 4582-635 - is this a jet bowshock? - looks triangular
  #+BEGIN_SRC sh
  xpaset -p ds9 fits j8oc16010_wcs/4582-635-Bally_16-extract.fits
  xpaset -p ds9 regions delete all
  xpaset -p ds9 align wcs
  xpaset -p ds9 zoom to fit
  xpaset -p ds9 scale limits 2.2 3.0
  xpaset -p ds9 cmap invert
  #+END_SRC

#+BEGIN_SRC sh :dir j8oc16010_wcs :results verbatim replace
  python ../programas/plot-image.py --image Bally_16 --vmin 2.3 --vmax 3.0 4582-635
#+END_SRC

#+RESULTS:
: 83.74236145833333 -5.4430909722222225
: 0.0008142692182078882
: INFO: Deleting work directory /var/folders/rm/hnrktx9s22g8sbms445k0z000000gn/T/tmpcm72nj [montage_wrapper.wrappers]
: INFO: Deleting work directory /var/folders/rm/hnrktx9s22g8sbms445k0z000000gn/T/tmpoivr4j [montage_wrapper.wrappers]
: No mask regions found

#+BEGIN_SRC sh :dir j8oc16010_wcs
  open 4582-635-Bally_16-images.pdf
#+END_SRC

So it is OK, but the stuuff outside could well be evidence that it is just a supeimposed jet bowshock

+ [X] 005-514 - trim outer shock points to south
  #+BEGIN_SRC sh
  xpaset -p ds9 fits j8oc16010_wcs/w005-514-Bally_16-extract.fits
  xpaset -p ds9 regions delete all
  xpaset -p ds9 align wcs
  xpaset -p ds9 zoom to fit
  xpaset -p ds9 scale limits 2.9 6.5
  xpaset -p ds9 cmap invert
  #+END_SRC

#+BEGIN_SRC sh 
  xpaset -p ds9 regions load j8oc16010_wcs/w005-514-forma.reg
#+END_SRC

#+BEGIN_SRC sh :dir j8oc16010_wcs :results verbatim replace
  python ../programas/find-xy-shell.py w005-514
  python ../programas/fit-circle-shell.py w005-514
  python ../programas/extract-image.py --fitsfile j8oc16010_wcs.fits w005-514
#+END_SRC
...
WARNING: AstropyBackwardsIncompatibleChangeWarning: Using the `ICRSCoordinates` name for this class is deprecated in v0.3, and will be removed in the next version. Use `ICRS` instead. [astropy.coordinates.old_builtin_systems_names]
[[Variables]]
     xc:    -0.793791 +/- 0.212554 (26.78%) initial = -0.980223
     yc:    -0.651800 +/- 0.201560 (30.92%) initial = -0.639983
[[Correlations]] (unreported correlations are <  0.100)
    C(xc, yc)                    =  0.982 
[[Variables]]
     xc:    -0.506096 +/- 0.209926 (41.48%) initial = -1.671639
     yc:    -0.202175 +/- 0.090012 (44.52%) initial =  0.028545
[[Correlations]] (unreported correlations are <  0.100)
    C(xc, yc)                    =  0.765 
WARNING: FITSFixedWarning: The WCS transformation has more axes (2) than the image it is associated with (0) [astropy.wcs.wcs]
WARNING: AstropyBackwardsIncompatibleChangeWarning: Using the `ICRSCoordinates` name for this class is deprecated in v0.3, and will be removed in the next version. Use `ICRS` instead. [astropy.coordinates.old_builtin_systems_names]
RA range: 5:34:59.5564 5:35:01.24917
Dec range: -5:25:25.4 -5:25:00.56
Extracted image window: [2782:3492, 5753:6214]
WARNING: Overwriting existing file 'w005-514-Bally_16-extract.fits'. [astropy.io.fits.file]
#+end_example

#+BEGIN_SRC sh :dir j8oc16010_wcs :results verbatim replace
  source activate py27
  python ../programas/arc_brightness.py w005-514
#+END_SRC

#+RESULTS:
: **************************************************
: Calculating shell brightness for Bally_16
: **************************************************
: No bad pixel mask found
: BG trimean = 3.63, iqr = 0.06
: Shell trimean = 4.21, iqr = 0.43
: Adopting plot range of 3.51 to 5.07

#+BEGIN_SRC sh :dir j8oc16010_wcs :results verbatim replace
  python ../programas/plot-image.py --image Bally_16 --vmin 2.9 --vmax 6.5 w005-514
#+END_SRC

#+RESULTS:
: 83.75196249999999 -5.420613888888889
: 0.0006219100795807592
: INFO: Deleting work directory /var/folders/rm/hnrktx9s22g8sbms445k0z000000gn/T/tmpon9f2n [montage_wrapper.wrappers]
: INFO: Deleting work directory /var/folders/rm/hnrktx9s22g8sbms445k0z000000gn/T/tmp3xn_2g [montage_wrapper.wrappers]
: No mask regions found

#+BEGIN_SRC sh :dir j8oc16010_wcs
  open w005-514-Bally_16-images.pdf
#+END_SRC
...
+ [X] 022-635 - trim outer shock points away from axis
  #+BEGIN_SRC sh
  xpaset -p ds9 fits j8oc16010_wcs/022-635-Bally_16-extract.fits
  xpaset -p ds9 regions delete all
  xpaset -p ds9 align wcs
  xpaset -p ds9 zoom to fit
  xpaset -p ds9 scale limits 2.55 3.5
  xpaset -p ds9 cmap invert
  #+END_SRC

#+BEGIN_SRC sh 
  xpaset -p ds9 regions load j8oc16010_wcs/022-635-forma.reg
#+END_SRC

#+BEGIN_SRC sh :dir j8oc16010_wcs :results verbatim replace
  python ../programas/find-xy-shell.py 022-635
  python ../programas/fit-circle-shell.py 022-635
  python ../programas/extract-image.py --fitsfile j8oc16010_wcs.fits 022-635
#+END_SRC
...
WARNING: AstropyBackwardsIncompatibleChangeWarning: Using the `ICRSCoordinates` name for this class is deprecated in v0.3, and will be removed in the next version. Use `ICRS` instead. [astropy.coordinates.old_builtin_systems_names]
[[Variables]]
     xc:    -1.507735 +/- 0.117263 (7.78%) initial = -0.732506
     yc:    -0.299054 +/- 0.030731 (10.28%) initial = -0.162168
[[Correlations]] (unreported correlations are <  0.100)
    C(xc, yc)                    =  0.912 
[[Variables]]
     xc:    -3.286607 +/- 0.462597 (14.08%) initial = -1.096470
     yc:    -0.597022 +/- 0.097536 (16.34%) initial = -0.130984
[[Correlations]] (unreported correlations are <  0.100)
    C(xc, yc)                    =  0.920 
WARNING: FITSFixedWarning: The WCS transformation has more axes (2) than the image it is associated with (0) [astropy.wcs.wcs]
WARNING: AstropyBackwardsIncompatibleChangeWarning: Using the `ICRSCoordinates` name for this class is deprecated in v0.3, and will be removed in the next version. Use `ICRS` instead. [astropy.coordinates.old_builtin_systems_names]
RA range: 5:35:01.55922 5:35:02.94431
Dec range: -5:26:46.27 -5:26:23.96
Extracted image window: [1295:1903, 5005:5615]
WARNING: Overwriting existing file '022-635-Bally_16-extract.fits'. [astropy.io.fits.file]
#+end_example

#+BEGIN_SRC sh :dir j8oc16010_wcs :results verbatim replace
  source activate py27
  python ../programas/arc_brightness.py 022-635
#+END_SRC
...
: **************************************************
: No bad pixel mask found
: BG trimean = 2.72, iqr = 0.05
: Shell trimean = 2.80, iqr = 0.06
: Adopting plot range of 2.62 to 2.92

#+BEGIN_SRC sh :dir j8oc16010_wcs :results verbatim replace
  python ../programas/plot-image.py --image Bally_16 --vmin 2.55 --vmax 3.5 022-635
#+END_SRC

#+RESULTS:
: 83.75916666666666 -5.443147222222223
: 0.0012376389115610646
: INFO: Deleting work directory /var/folders/rm/hnrktx9s22g8sbms445k0z000000gn/T/tmprrsu5h [montage_wrapper.wrappers]
: INFO: Deleting work directory /var/folders/rm/hnrktx9s22g8sbms445k0z000000gn/T/tmp0c7q09 [montage_wrapper.wrappers]
: No mask regions found

#+BEGIN_SRC sh :dir j8oc16010_wcs
  open 022-635-Bally_16-images.pdf
#+END_SRC

+ [X] 041-637 - trim outer shock points away from axis
  #+BEGIN_SRC sh
  xpaset -p ds9 fits j8oc16010_wcs/041-637-Bally_16-extract.fits
  xpaset -p ds9 regions delete all
  xpaset -p ds9 align wcs
  xpaset -p ds9 zoom to fit
  xpaset -p ds9 scale limits 2.7 3.2
  xpaset -p ds9 cmap invert
  #+END_SRC

#+BEGIN_SRC sh 
  xpaset -p ds9 regions load j8oc16010_wcs/041-637-forma.reg
#+END_SRC

#+BEGIN_SRC sh :dir j8oc16010_wcs :results verbatim replace
  python ../programas/find-xy-shell.py 041-637
  python ../programas/fit-circle-shell.py 041-637
  python ../programas/extract-image.py --fitsfile j8oc16010_wcs.fits 041-637
#+END_SRC

#+RESULTS:
#+begin_example
WARNING: AstropyBackwardsIncompatibleChangeWarning: Using the `ICRSCoordinates` name for this class is deprecated in v0.3, and will be removed in the next version. Use `ICRS` instead. [astropy.coordinates.old_builtin_systems_names]
Warning: Closest point of inner arc is at one end, using all points in parabola fit
[[Variables]]
     xc:    -0.110713 +/- 0.089542 (80.88%) initial = -0.317276
     yc:    -2.035671 +/- 0.130180 (6.39%) initial = -1.145374
[[Correlations]] (unreported correlations are <  0.100)
    C(xc, yc)                    =  0.947 
[[Variables]]
     xc:    -0.248792 +/- 0.077250 (31.05%) initial = -0.142779
     yc:    -2.465663 +/- 0.153325 (6.22%) initial = -1.932033
[[Correlations]] (unreported correlations are <  0.100)
    C(xc, yc)                    =  0.930 
WARNING: FITSFixedWarning: The WCS transformation has more axes (2) than the image it is associated with (0) [astropy.wcs.wcs]
WARNING: AstropyBackwardsIncompatibleChangeWarning: Using the `ICRSCoordinates` name for this class is deprecated in v0.3, and will be removed in the next version. Use `ICRS` instead. [astropy.coordinates.old_builtin_systems_names]
RA range: 5:35:03.36148 5:35:04.97355
Dec range: -5:26:47.68 -5:26:25.14
Extracted image window: [839:1500, 5359:6019]
WARNING: Overwriting existing file '041-637-Bally_16-extract.fits'. [astropy.io.fits.file]
#+end_example

#+BEGIN_SRC sh :dir j8oc16010_wcs :results verbatim replace
  source activate py27
  python ../programas/arc_brightness.py 041-637
#+END_SRC
...
: **************************************************
: No bad pixel mask found
: BG trimean = 2.93, iqr = 0.11
: Shell trimean = 2.97, iqr = 0.10
: Adopting plot range of 2.71 to 3.16

#+BEGIN_SRC sh :dir j8oc16010_wcs :results verbatim replace
  python ../programas/plot-image.py --image Bally_16 --vmin 2.7 --vmax 3.2 041-637
#+END_SRC

#+RESULTS:
: 83.76691666666665 -5.443627777777778
: 0.0012208432087212264
: INFO: Deleting work directory /var/folders/rm/hnrktx9s22g8sbms445k0z000000gn/T/tmpvarkm0 [montage_wrapper.wrappers]
: INFO: Deleting work directory /var/folders/rm/hnrktx9s22g8sbms445k0z000000gn/T/tmph6x3fb [montage_wrapper.wrappers]
: No mask regions found

#+BEGIN_SRC sh :dir j8oc16010_wcs
  open 041-637-Bally_16-images.pdf
#+END_SRC


+ [X] 044-527 - fix inner shock
  #+BEGIN_SRC sh
  xpaset -p ds9 fits j8oc01010_wcs/w044-527-Bally_01-extract.fits
  xpaset -p ds9 regions delete all
  xpaset -p ds9 align wcs
  xpaset -p ds9 zoom to fit
  xpaset -p ds9 scale limits 6.0 8.5
  xpaset -p ds9 cmap invert
  #+END_SRC

#+BEGIN_SRC sh 
  xpaset -p ds9 regions load j8oc01010_wcs/w044-527-forma.reg
#+END_SRC

#+BEGIN_SRC sh :dir j8oc01010_wcs :results verbatim replace
  python ../programas/find-xy-shell.py w044-527
  python ../programas/fit-circle-shell.py w044-527
  python ../programas/extract-image.py --fitsfile j8oc01010_wcs.fits w044-527
#+END_SRC
...
Warning: only 0 points within 90 deg of axis. Using all points instead
[[Variables]]
     xc:    -0.175714 +/- 0.066485 (37.84%) initial =  0.779094
     yc:     0.359200 +/- 0.013458 (3.75%) initial =  0.034886
[[Correlations]] (unreported correlations are <  0.100)
    C(xc, yc)                    =  0.801 
[[Variables]]
     xc:    -0.961765 +/- 0.700200 (72.80%) initial = -1.822271
     yc:     0.565726 +/- 0.074196 (13.12%) initial =  1.102037
[[Correlations]] (unreported correlations are <  0.100)
    C(xc, yc)                    =  0.401 
WARNING: FITSFixedWarning: The WCS transformation has more axes (2) than the image it is associated with (0) [astropy.wcs.wcs]
WARNING: AstropyBackwardsIncompatibleChangeWarning: Using the `ICRSCoordinates` name for this class is deprecated in v0.3, and will be removed in the next version. Use `ICRS` instead. [astropy.coordinates.old_builtin_systems_names]
RA range: 5:35:03.835 5:35:05.24797
Dec range: -5:25:37.75 -5:25:15.64
Extracted image window: [1561:2172, 642:1254]
WARNING: Overwriting existing file 'w044-527-Bally_01-extract.fits'. [astropy.io.fits.file]
#+end_example

#+BEGIN_SRC sh :dir j8oc01010_wcs :results verbatim replace
  source activate py27
  python ../programas/arc_brightness.py w044-527
#+END_SRC
...
: **************************************************
: No bad pixel mask found
: BG trimean = 6.78, iqr = 0.35
: Shell trimean = 7.01, iqr = 0.43
: Adopting plot range of 6.08 to 7.86

#+BEGIN_SRC sh :dir j8oc01010_wcs :results verbatim replace
  python ../programas/plot-image.py --image Bally_01 --vmin 6.0 --vmax 8.5 w044-527
#+END_SRC

#+RESULTS:
: 83.76844583333332 -5.424275000000001
: 0.0009028163236866665
: INFO: Deleting work directory /var/folders/rm/hnrktx9s22g8sbms445k0z000000gn/T/tmpa7ah_e [montage_wrapper.wrappers]
: INFO: Deleting work directory /var/folders/rm/hnrktx9s22g8sbms445k0z000000gn/T/tmpnr61aq [montage_wrapper.wrappers]
: No mask regions found

#+BEGIN_SRC sh :dir j8oc01010_wcs
  open w044-527-Bally_01-images.pdf
#+END_SRC
...
#+call: find-fit-extract(source="049-143", field="09") :results verbatim replace
...
Warning: Closest point of inner arc is at one end, using all points in parabola fit
[[Variables]]
     xc:    -0.042428 +/- 0.031684 (74.68%) initial = -0.409580
     yc:     0.027929 +/- 0.021221 (75.98%) initial =  0.471532
[[Correlations]] (unreported correlations are <  0.100)
    C(xc, yc)                    = -0.869 
[[Variables]]
     xc:    -2.909361 +/- 0.491963 (16.91%) initial = -1.142830
     yc:     0.522770 +/- 0.098664 (18.87%) initial =  0.266095
[[Correlations]] (unreported correlations are <  0.100)
    C(xc, yc)                    = -0.773 
WARNING: FITSFixedWarning: The WCS transformation has more axes (2) than the image it is associated with (0) [astropy.wcs.wcs]
WARNING: AstropyBackwardsIncompatibleChangeWarning: Using the `ICRSCoordinates` name for this class is deprecated in v0.3, and will be removed in the next version. Use `ICRS` instead. [astropy.coordinates.old_builtin_systems_names]
RA range: 5:35:04.2853 5:35:05.69829
Dec range: -5:21:54.67 -5:21:31.31
Extracted image window: [740:1369, 3842:4472]
WARNING: Overwriting existing file '049-143-Bally_09-extract.fits'. [astropy.io.fits.file]
"
#+end_example

#+call: arc-brightness(source="049-143", field="09")  :results verbatim replace

#+RESULTS:
: "**************************************************
: Calculating shell brightness for Bally_09
: **************************************************
: No bad pixel mask found
: BG trimean = 7.82, iqr = 0.22
: Shell trimean = 7.96, iqr = 0.12
: Adopting plot range of 7.38 to 8.20
: "

#+call: plot-image(source="049-143", field="09", vmin="6.8", vmax="9.5")  :results verbatim replace

#+RESULTS:
: "83.77060416666666 -5.361922222222222
: 0.0011605359657427174
: INFO: Deleting work directory /var/folders/rm/hnrktx9s22g8sbms445k0z000000gn/T/tmp1e2ggc [montage_wrapper.wrappers]
: INFO: Deleting work directory /var/folders/rm/hnrktx9s22g8sbms445k0z000000gn/T/tmpnoms46 [montage_wrapper.wrappers]
: No mask regions found
: "
...
#+call: find-fit-extract(source="051-024", field="09") :results verbatim replace

#+RESULTS:
#+begin_example
"WARNING: AstropyBackwardsIncompatibleChangeWarning: Using the `ICRSCoordinates` name for this class is deprecated in v0.3, and will be removed in the next version. Use `ICRS` instead. [astropy.coordinates.old_builtin_systems_names]
[[Variables]]
     xc:    -0.581884 +/- 0.111453 (19.15%) initial = -0.745252
     yc:     0.499692 +/- 0.112251 (22.46%) initial =  0.495043
[[Correlations]] (unreported correlations are <  0.100)
    C(xc, yc)                    = -0.963 
[[Variables]]
     xc:    -0.731958 +/- 0.106078 (14.49%) initial = -0.816505
     yc:     0.806276 +/- 0.106147 (13.17%) initial =  0.860521
[[Correlations]] (unreported correlations are <  0.100)
    C(xc, yc)                    = -0.971 
WARNING: FITSFixedWarning: The WCS transformation has more axes (2) than the image it is associated with (0) [astropy.wcs.wcs]
WARNING: AstropyBackwardsIncompatibleChangeWarning: Using the `ICRSCoordinates` name for this class is deprecated in v0.3, and will be removed in the next version. Use `ICRS` instead. [astropy.coordinates.old_builtin_systems_names]
RA range: 5:35:04.45936 5:35:05.89026
Dec range: -5:20:35.63 -5:20:14.34
Extracted image window: [1797:2401, 5015:5619]
WARNING: Overwriting existing file '051-024-Bally_09-extract.fits'. [astropy.io.fits.file]
"
#+end_example

#+call: arc-brightness(source="051-024", field="09")  :results verbatim replace
...
: **************************************************
: No bad pixel mask found
: BG trimean = 6.34, iqr = 0.15
: Shell trimean = 6.38, iqr = 0.13
: Adopting plot range of 6.03 to 6.64
: "

#+call: plot-image(source="051-024", field="09", vmin="5.3", vmax="7.5")  :results verbatim replace

#+RESULTS:
: "83.77137916666663 -5.340088888888888
: 0.0006352322955144185
: INFO: Deleting work directory /var/folders/rm/hnrktx9s22g8sbms445k0z000000gn/T/tmpwvjm4b [montage_wrapper.wrappers]
: INFO: Deleting work directory /var/folders/rm/hnrktx9s22g8sbms445k0z000000gn/T/tmp0t8fix [montage_wrapper.wrappers]
: No mask regions found
: "
...
#+call: arc-brightness(source="074-229", field="01")  :results verbatim replace
...
: **************************************************
: No bad pixel mask found
: BG trimean = 11.55, iqr = 0.32
: Shell trimean = 12.11, iqr = 0.46
: Adopting plot range of 10.91 to 13.04
: "
...
#+call: arc-brightness(source="101-233", field="01")  :results verbatim replace
...
: **************************************************
: No bad pixel mask found
: BG trimean = 28.40, iqr = 2.88
: Shell trimean = 28.11, iqr = 2.61
: Adopting plot range of 22.64 to 33.34
: "
...
#+call: arc-brightness(source="106-245", field="01")  :results verbatim replace
...
: **************************************************
: No bad pixel mask found
: BG trimean = 31.70, iqr = 0.40
: Shell trimean = 34.09, iqr = 1.75
: Adopting plot range of 30.90 to 37.59
: "

#+call: plot-image(source="106-245", field="01", vmin="24", vmax="45")

#+call: view-pdf(source="106-245", field="01")
...
#+call: arc-brightness(source="119-3155", field="14")  :results verbatim replace

#+RESULTS:
: "**************************************************
: Calculating shell brightness for Bally_14
: **************************************************
: No bad pixel mask found
: BG trimean = 0.77, iqr = 0.02
: Shell trimean = 0.80, iqr = 0.02
: Adopting plot range of 0.74 to 0.84
: "
...
#+call: arc-brightness(source="138-3024", field="14")  :results verbatim replace
...
: **************************************************
: No bad pixel mask found
: BG trimean = 0.87, iqr = 0.03
: Shell trimean = 0.88, iqr = 0.03
: Adopting plot range of 0.81 to 0.94
: "
...
#+call: arc-brightness(source="142-301", field="01")  :results verbatim replace
...
: **************************************************
: No bad pixel mask found
: BG trimean = 64.89, iqr = 3.75
: Shell trimean = 73.18, iqr = 4.86
: Adopting plot range of 57.38 to 82.89
: "
...
#+call: plot-image(source="212-400", field="06", vmin="20", vmax="33")
